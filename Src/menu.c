...
// menu objects
MENU mainscreen = {&show_main_screen,1,0,{&main_menu,NULL,NULL,NULL,NULL,NULL,NULL},NULL,NULL};
MENU main_menu = {&show_menu,4,0,{&settings_menu, &apps_menu,&dfu_menu,&status_menu,NULL,NULL,NULL},&mainscreen,&main_line};
	MENU settings_menu = { &show_menu,2,0,{&set_time_menu,&acc_set_menu,NULL,NULL,NULL,NULL,NULL},&main_menu,&set_line};
		...
		MENU acc_set_menu = { &show_menu,4,0,{&tilt_set_menu,&tap_set_menu,&wum_set_menu,&buf_set_menu,NULL,NULL,NULL},&settings_menu,&acc_settings_line};
